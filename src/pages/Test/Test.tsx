...
const Test: React.FC<IProps> = () => {
  ...
  const fn = async () => {
    ...
    // Simulate can be used to check for errors before sending a transaction
    // await contract.simulate.transfer(["0x5b5Dc6A42FB4e8C1a71E6164584D18cCEBD65725", toWei("0.5", 6)]);
